    ...
    return (
        <Col md="3" className="input-wrapper">
            <Row>
                ...
                <Col md="10">
                    <input placeholder={props.placeholder} value={props.state} type='text' onChange={props.handleChange} />
                </Col>
            </Row>
            <Row>
                <Col md='2'></Col>
...
class MadlibForm extends Component {
    ...
    render() {
        ...
        this.inputData = [
            ...
            {placeholder: 'Noun (Plural)', prop: 'plurarNoun', state: this.state.pluralNoun},
      ...
      return (
          <div className="card-wrapper">
            <Card>
                ...
                <MadlibContent data={this.state.color}/>
            </Card>
          </div>
