      ...
      return (
        <Row style={{textAlign: 'center', color: 'white'}}>
            <Col md="3" className="inputWrapper">
                ...
                <Row>
                    <Col md="12">
                      <div className="inputDescrition">Color</div>
                    </Col>
                </Row>
            </Col>
            <Col md="3" className="inputWrapper">
                ...
                <Row>
                    <Col md="12">
                      <div className="inputDescrition">Noun (Plural)</div>
                    </Col>
                </Row>
            </Col>
            <Col md="3" className="inputWrapper">
                ...
                <Row>
                    <Col md="12">
                      <div className="inputDescrition">Adjective</div>
                    </Col>
                </Row>
            </Col>
            <Col md="3" className="inputWrapper">
                ...
                <Row>
                    <Col md="12">
                      <div className="inputDescrition">Celebrity</div>
                    </Col>
                </Row>
            </Col>
        </Row>
